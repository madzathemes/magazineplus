...
<div class="container mt-content-container">
	<div class="row">
		<div class="col-md-12">
			...
			<?php if($grid!=0) { echo do_shortcode('[grid type="'.esc_attr($grid).'" title="'. esc_html__( 'Category','magazineplus' ) .': '.esc_attr($cat_title).'" title_type="left" category="'.esc_attr($cat_slug).'"  ]'); ?>
