...
add_action( 'tgmpa_register', 'magazineplus_register_required_plugins' );
/**
 ...
 */
function magazineplus_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'			=> esc_html__( "Envato WordPress Toolkit","magazineplus" ), // The plugin name
        ...
        array(
        			'name'     				=> esc_html__( "Page Builder by SiteOrigin","magazineplus" ), // The plugin name
        			'slug'     				=> 'siteorigin-panels', // The plugin slug (typically the folder name)
        			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
              'force_activation'		=> false,
        ),
        array(
        			'name'     				=> esc_html__( "One Click Demo Import","magazineplus" ), // The plugin name
        			'slug'     				=> 'one-click-demo-import', // The plugin slug (typically the folder name)
        			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
              'force_activation'		=> false,
        ),
        array(
            'name'			=> esc_html__( "Magazin","magazineplus" ), // The plugin name
     ...
     */
    $config = array(
      'id'           => 'magazineplus',                // Unique ID for hashing notices for multiple instances of TGMPA.
