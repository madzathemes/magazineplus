<?php function magazineplus_single_top() {
...
function magazineplus_single_bottom() {
...
?><?php wp_link_pages(); ?>
  ...
  <ul class="share down">
    <li class="share-facebook"><a href="http://www.facebook.com/sharer.php?u=<?php the_permalink();?>" target="_blank"><span><?php echo esc_html__('Share Post', 'magazineplus'); ?></span></a></li>
    ...
    <?php if ( get_the_author_meta( 'description' )) { ?>
      <div class="author-info">
        <div class="author-avatar">
          <?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'magazineplus_author_bio_avatar_size', 30 ) ); ?>
        </div>
        <div class="author-description">
          <h2><?php printf( esc_html__( 'About %s', 'magazineplus' ), get_the_author() ); ?></h2>
  ...
  <ul class="nav-single">
    <li class="previous pull-left"><?php previous_post_link( '%link', '<span class="color-silver-light">' . esc_html__( 'Previous article','magazineplus' ) . '</span><div>%title</div>' ); ?></li>
    <li class="next pull-right"><?php next_post_link( '%link', ' <span class="color-silver-light">' . esc_html__( 'Next article','magazineplus' ) . '</span><div>%title</div>' ); ?></li>
  ...
  <?php if ( is_active_sidebar( 'sidebar-single-bottom-widget-area-before' ) ) {
    ...
    dynamic_sidebar( 'sidebar-single-bottom-widget-area-before' );
     ...
     echo do_shortcode('[posts title="'. esc_html__( 'You may be interested','magazineplus' ) .'" title_type="left" type=normal-right item_nr=3 ]');
  ...
  if ( is_active_sidebar( 'sidebar-single-bottom-widget-area-after' ) ) {
    ...
    echo do_shortcode('[posts title="'. esc_html__( 'Most from this category','magazineplus' ) .'" title_type="left" type=normal-two item_nr=4 offset=3]');
